...
public class ConcurrentRMA6Crawler implements Callable<RMA6BlastCrawler> {
	  ...
	  public ConcurrentRMA6Crawler(String dir, String name, String species, String out, NCBI_MapReader reader, Logger warning, NCBI_TreeReader treeReader, Filter f)
	  {
	    inDir = dir;
	    fileName = name;
	    speciesName = species;
