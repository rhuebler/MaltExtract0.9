...
public class RMA6BlastCrawler {
	...
	public RMA6BlastCrawler(String dir, String name, String species, String out, NCBI_MapReader reader, Logger warning, NCBI_TreeReader treeReader, Filter filter) {
	    inDir = dir;
	    fileName = name;
	    speciesName = species;
	    mapReader = reader;
