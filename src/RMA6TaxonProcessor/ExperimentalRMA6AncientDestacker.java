...
public class ExperimentalRMA6AncientDestacker extends RMA6TaxonProcessor {
	...
	public ExperimentalRMA6AncientDestacker(Integer id, double pID, NCBI_MapReader reader, boolean v, Logger log, Logger warning, double tp, int mL, Filter behave) {
	  ...
	  public ExperimentalRMA6AncientDestacker(int id, double pID, NCBI_MapReader reader, boolean v, Logger log, Logger warning, boolean reads, double tp, int mL, boolean wantAls, boolean turnOffDestacking, Filter behave) {
	    super(Integer.valueOf(id), pID, reader, v, log, warning, tp, mL, behave);
	    wantReads = reads;
	    wantAlignments = wantAls;
	  }
