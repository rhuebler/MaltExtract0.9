...
public class ExperimentalRMA6Destacker extends RMA6TaxonProcessor {
	protected boolean wantReads = false;
	  ...
	  public ExperimentalRMA6Destacker(int id, double pID, NCBI_MapReader reader, boolean v, Logger log, Logger warning, boolean reads, double tp, int mL, boolean wantAls, boolean turnOffDestacking, Filter behave) {
